...
# Total 19146 records exported to CRMLSSold202602.csv
...
if token:
    ...
    params = {
        ...
        '$filter': f"MlsStatus eq 'Closed' and CloseDate ge {datetime(2025, 1, 1).isoformat(timespec='milliseconds')}Z and CloseDate lt {datetime(2025, 2, 1).isoformat(timespec='milliseconds')}Z",
        '$top': 1000  # Extracting up to 1000 observations
    }

    # Send a GET request to the API endpoint with the token and parameters
    total_records = 0
    csv_file = 'csv/CRMLSSold202501.csv'
